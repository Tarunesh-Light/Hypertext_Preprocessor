...
/*
  ...
  $_REQUEST - Contains information about variables passed through the form or URL.Alternative for $_GET and $_POST
*/
var_dump($_SERVER);  //SERVER related information
echo "<br>";
